...
import Jhc.FrontEnd.Rename(DeNameable(..))
import Jhc.FrontEnd.SrcLoc(bogusASrcLoc,MonadSrcLoc(..))
...
import {-# SOURCE #-} Jhc.FrontEnd.Tc.Class(simplify)
