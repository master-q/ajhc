...
import Jhc.Doc.DocLike(tupled)
import Jhc.DerivingDrift.Drift
import Jhc.FrontEnd.Desugar (desugarHsModule,doToExp,listCompToExp)
import Jhc.FrontEnd.HsSyn
import Jhc.FrontEnd.SrcLoc hiding(srcLoc)
import qualified Jhc.FrontEnd.SrcLoc
import Jhc.FrontEnd.Syn.Traverse
...
import qualified Jhc.FrontEnd.HsErrors as HsErrors
import qualified Jhc.Name.VConsts as V
