module Jhc.E.LambdaLift(lambdaLift,staticArgumentTransform)  where
...
import Jhc.E.Values
import Jhc.Fixer.Fixer
import Jhc.Fixer.Supply
import Jhc.GenUtil
import Jhc.Name.Id
import Jhc.Name.Name
import Jhc.Options (verbose)
import Jhc.Stats(mtick,runStatM,runStatT)
import Jhc.StringTable.Atom
import Jhc.Support.CanType
import Jhc.Support.FreeVars
import Jhc.Util.Graph as G
import Jhc.Util.HasSize
import Jhc.Util.SetLike hiding(Value)
