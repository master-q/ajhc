...
module Jhc.E.Main(processInitialHo,processDecls,compileWholeProgram,dumpRules) where
...
import Jhc.E.Annotate(annotateDs,annotateCombs,annotateProgram)
import Jhc.E.E
import Jhc.E.Eta
import Jhc.E.FromHs
import Jhc.E.Inline
import Jhc.E.LambdaLift
import Jhc.E.LetFloat
import Jhc.E.Lint
import Jhc.E.Program
import Jhc.E.Rules
import Jhc.E.Traverse
import Jhc.E.TypeAnalysis
import Jhc.E.TypeCheck
import Jhc.E.Values
import Jhc.E.WorkerWrapper
import Jhc.FrontEnd.Class(augmentClassHierarchy)
import Jhc.FrontEnd.HsSyn
import Jhc.FrontEnd.KindInfer
import Jhc.FrontEnd.Tc.Module
import Jhc.FrontEnd.Warning
...
import Jhc.Options
import Jhc.Support.CanType(getType)
import Jhc.Support.FreeVars
import Jhc.Support.TempDir
import Jhc.Support.Transform
import Jhc.Util.Gen
import Jhc.Util.Graph
import Jhc.Util.Progress
import Jhc.Util.SetLike as S
import qualified Jhc.E.CPR
import qualified Jhc.E.Demand as Demand(analyzeProgram)
import qualified Jhc.E.SSimplify as SS
import qualified Jhc.FlagDump as FD
import qualified Jhc.FlagOpts as FO
import qualified Jhc.Info.Info as Info
import qualified Jhc.Stats
